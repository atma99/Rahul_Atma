    ...
    constructor(props){
        ...
        this.state = {
            experiences: [
                ...
                {id: 2, position: "Strategic Planning & Operations Intern", company: "Chartwell Retirement Residences", description: "Cross-functional collaboration during budgeting periods to ensure accurate financial provisions for upcoming fiscal year. Assisted strategic planning analysts in population demographic analysis. Create consolidation files and market competitor templates using MS Office Suite, primarily Excel. Use Oracle’s Hyperion program to run reports, enter budget information, and enter staffing changes.", imSrc: Chartwell}
            ]
        }
